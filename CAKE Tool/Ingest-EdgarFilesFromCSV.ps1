...
<#
    ...
    [Environment]::SetEnvironmentVariable("USER_EMAIL", "admin@M365CPI05184678.onmicrosoft.com", "User")
    [Environment]::SetEnvironmentVariable("AZURE_CLIENT_SECRET", "TBD", "User")
    [Environment]::SetEnvironmentVariable("AZURE_CLIENT_ID", "4d79e88d-603b-4284-a90d-c6bf32cdfc8e", "User")
    [Environment]::SetEnvironmentVariable("AZURE_TENANT_ID", "144b8c80-398d-405e-8055-fc9a9d5013f8", "User")
#>
...
$tickerStrings='JPM,PNC,BAC,WFC,USB'.Split(',')
...
$def = Import-Csv -Path './def_filings.csv'
